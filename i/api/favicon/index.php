...
<head>
    ...
    <title>网站Favicon图标获取 - 免费API - <?php echo $website_array["website_banner"];?></title>
...
<body class="home-template">
    <header class="site-header">
        ...
        <div class="container jumbotron">
            <div class="row">
                <div class="col-xs-12">
                    <h1><img src="/img/API1.svg" alt="APIlogo" class="hidden">网站Favicon图标获取</h1>
                    <p>获取指定站点Favicon.ico图标</p>
                </div>
            </div>
        </div>
    ...
    <main class="container tab-content" id="myTabContent">
        <article class="markdown-body tab-pane fade in active" id="api">
            <div class="api-sub-content">
                <div class="simpleline"><strong>接口地址：</strong><span class="url"><?php echo $website_array["api_url"];?><?php echo basename(dirname(__FILE__))?>/get</span></div>
                ...
                <div class="simpleline"><strong>请求示例：</strong><span class="url"><?php echo $website_array["api_url"];?><?php echo basename(dirname(__FILE__))?>/get?url=www.baidu.com</span></div>
