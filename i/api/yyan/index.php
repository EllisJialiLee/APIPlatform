...
<head>
    ...
    <title>随机一言语录 - 免费API - <?php echo $website_array["website_banner"];?></title>
...
<body class="home-template">
    <header class="site-header">
        ...
        <div class="container jumbotron">
            <div class="row">
                <div class="col-xs-12">
                    <h1><img src="/img/API1.svg" alt="APIlogo" class="hidden">随机一言语录</h1>
                    <p>每天定时送上一碗毒鸡汤</p>
                </div>
            </div>
        </div>
    ...
    <main class="container tab-content" id="myTabContent">
        <article class="markdown-body tab-pane fade in active" id="api">
            <div class="api-sub-content">
                ...
                <div class="simpleline"><strong>请求示例：</strong><span class="url"><?php echo $website_array["api_url"];?><?php echo basename(dirname(__FILE__))?>/api?encode=js</span></div>
				<div class="simpleline"><strong>请求示例：</strong><span class="url"><?php echo $website_array["api_url"];?><?php echo basename(dirname(__FILE__))?>/api?charset=utf-8</span></div>
		          <div class="simpleTable">
		              <p class="linep">参数说明：</p>
		              ...
		              <tbody><tr class="title">
		                  ...
		                  <th>说明</th>
		              		            ...
		              		            <tr>
		                  <td>&nbsp;</td>
		                  <td class="url">charset</td>
		                  <td class="url">string</td>
		                  <td>字符编码（gbk/utf-8）</td>
		              </tr>
		              		            <tr>
		                  <td>&nbsp;</td>
		                  <td class="url">encode</td>
		                  <td class="url">string</td>
...
js输出：function binduyan(){document.write('');}
</pre></div>		    </div>
		</div>
        </article>
        ...
        <article class="markdown-body tab-pane fade" id="demo">
            <div class="simpleTable">
                <p class="linep">备注</p>
		    <div class="prediv">
		    	<pre>html调用举例:&lt;iframe src="https://api.liecnk.com/yan/api.php">&lt;/iframe>
js调用举例:&lt;script src="https://api.liecnk.com/yan/api.php?encode=js">&lt;/script>
