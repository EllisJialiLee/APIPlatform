...
<title>Favicon图标获取-免费API-利熙网络</title>
</head>
<style type="text/css">
...
<div style="box-shadow: 5px 5px 25px 0 rgba(46,61,73,.2);border-radius:15px;font-size:13px;width:950px;font-family:微软雅黑,'Helvetica Neue',Arial,sans-serif;margin:10px auto 0px;border:0px solid #eee;max-width:100%;">
    <div style="width:100%;background-color: #3174ed;background-image: linear-gradient(90deg, #3174ed 0%, #FA8BFF 35%, #3fd9fb 88%);color:#FFFFFF;border-radius:15px 15px 0 0;">
        <h2 style="font-size:15px;word-break:break-all;padding:20px 32px;margin:0;text-align:center">Favicon图标获取-免费API-利熙网络</h2>
    </div>
    <div style="margin:0px auto;width:90%">
		...
		<hr>
		# 请求地址 #<br/>
		<a style="color:#fd4b5c;text-decoration:none;">https://api.liecnk.com/favicon/get.php</a><br/>
		# 参数 #<br/>
		<li>url //网站地址(必填)</li>
		<hr>
		# 返回数据 #<br/>
		...
		<hr>
		# 备注 #<br/>
		网址前面的http://可以加，也可以不加。但如果是https://头，则必须加上<br/>
		<hr>
		# 示例 #<br/>
		<a style="color:#fd4b5c;text-decoration:none；" target="_blank">&#60img src="https://api.liecnk.com/favicon/get.php?url=www.baidu.com"/></a>
		</h3>
          </div>
</div>
</html>