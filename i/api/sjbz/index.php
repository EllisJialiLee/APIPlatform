...
<head>
    ...
    <title>随机壁纸美图 - 免费API - <?php echo $website_array["website_banner"];?></title>
...
<body class="home-template">
    <header class="site-header">
        ...
        <div class="container jumbotron">
            <div class="row">
                <div class="col-xs-12">
                    <h1><img src="/img/API1.svg" alt="APIlogo" class="hidden">随机美图壁纸</h1>
                    <p>每次刷新带给你不同体验</p>
                </div>
            </div>
        </div>
    ...
    <main class="container tab-content" id="myTabContent">
        <article class="markdown-body tab-pane fade in active" id="api">
            <div class="api-sub-content">
                ...
                <div class="simpleline"><strong>请求示例：</strong><span class="url"><?php echo $website_array["api_url"];?><?php echo basename(dirname(__FILE__))?>/api??method=pc&lx=suiji</span></div>
                <div class="simpleTable">
		          ...
		          <tbody>
		              <tr class="title">
		                  ...
		                  <td class="url">否</td>
		                  <td class="url">string</td>
		                  <td>dongman（动漫壁纸）,meizi（美女壁纸）,fengjing（风景壁纸）,suiji（动漫和美女随机）</td>
		              </tr>
		              		          </tbody>
		          </table>
		          </div>
