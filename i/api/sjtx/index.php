...
<head>
    ...
    <title>随机头像美图 - 免费API - <?php echo $website_array["website_banner"];?></title>
...
<body class="home-template">
    <header class="site-header">
        ...
        <div class="container jumbotron">
            <div class="row">
                <div class="col-xs-12">
                    <h1><img src="/img/API1.svg" alt="APIlogo" class="hidden">随机头像美图</h1>
                    <p>随机输出各类美图头像</p>
                </div>
            </div>
        </div>
    ...
    <main class="container tab-content" id="myTabContent">
        <article class="markdown-body tab-pane fade in active" id="api">
            <div class="api-sub-content">
                ...
                <div class="simpleline"><strong>请求示例：</strong><span class="url"><?php echo $website_array["api_url"];?><?php echo basename(dirname(__FILE__))?>/api?lx=c1</span></div>
                <div class="simpleTable">
		          ...
		          <tbody>
		              <tr class="title">
		                  ...
		                  <td>a1（男头）,b1（女头）,c1（动漫）,c2（动漫女头）,c3（动漫男头）</td>
		              </tr>
		              		          </tbody>
		          </table>
		          </div>
