...
<head>
    ...
    <title>获取QQ信息 - 免费API - <?php echo $website_array["website_banner"];?></title>
...
<body class="home-template">
    <header class="site-header">
        ...
        <div class="container jumbotron">
            <div class="row">
                <div class="col-xs-12">
                    <h1><img src="/img/API1.svg" alt="APIlogo" class="hidden">获取QQ信息</h1>
                    <p>获取QQ昵称和头像</p>
                </div>
            </div>
        </div>
    ...
    "code": 1,
    "imgurl": "https://q.qlogo.cn/headimg_dl?dst_uin=1576384173&spec=640",
    "name": "利熙网络"
}

{"code":-1,"msg":"Error"}</pre></div>		    </div>
		</div>
        </article>
